...
import { AiOutlineInstagram, AiOutlineFacebook, AiOutlineGithub, AiOutlineGooglePlus } from 'react-icons/ai'
...
function Contact() {
  ...
  const handleRedirect = (value: string) => window.open(value, '_blank')
